...
options = struct(...
    ...
    'Run_Cost_Pre_Boundary',   0,...
    'Run_Cost_Out_In',         0,...
    'Run_Real_MDT',            0,...
    'Run_Sandbox',             0,...
    'Run_Zhang_Zhuagn_Braatz', 0,...
    'force_rebuild_modes',     1,... %Force everything to rebuild
...
if options.Run_Cost_Pre_Boundary
    [c.Pre_Boundary, gamma.Pre_Boundary, S_cost.Pre_Boundary] =...
        BoundaryPreUB(c, m, options);
end

if options.Run_Cost_Out_In
    [c.Out_In, gamma.Out_In, S_cost.Out_In] =...
        OutInUB(c, m, options);
end
